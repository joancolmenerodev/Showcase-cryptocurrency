...
class CryptoDetailActivityTest : BaseTest<CryptoDetailActivity>() {
    ...
    private val cryptoDetailPage = CryptoDetailPage(context)

    @Before
    override fun setUp() {
        super.setUp()
        launchActivity(CryptoDetailActivity.getCryptoDetailActivityIntent(context, CRYPTO_ID))
    }
